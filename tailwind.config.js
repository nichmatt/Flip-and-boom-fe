  ...
  theme: {
    extend: {
      animation: {
        ...
        attackBombSelf: "attackBombSelf 2789ms linear infinite",
      },
      keyframes: {
        attackBomb: {
          "20%": { transform: "translateX(17.6rem) rotate(180deg) scale(1.5)" },
          ...
          "100%": {
            transform: "translateX(68rem) rotate(880deg) scale(1)",
          },
        },
        attackBombSelf: {
          "20%": {
            transform: "translateX(-17.6rem) rotate(-180deg) scale(1.5)",
          },
          "40%": { transform: "translateX(-31.2rem) rotate(-360deg) scale(2)" },
          "50%": {
