...
export default function PowerUpModal({
  ...
  return (
    <>
      ...
      >
        <div
          className={`w-[37.5%] h-[55.5%] backdrop-blur-[2px] rounded-[5px] text-white font-bold animate__animated ${animateChildren} flex flex-col px-10 justify-center items-center italic tracking-tighter`}
          style={{
            background:
